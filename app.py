...
def imagechange():
    ...
    print("컨트롤러 아이디 {}, 비번 {}".format(image, color))
    image = ImageService('image_handling/lena.jpg')
    raw_data = image.create_raw_data()
    render_params = {}
    val = image.make_session(raw_data, image, color)
    render_params['result'] = val
    return render_template('lena.jpg', result=val)
"""
